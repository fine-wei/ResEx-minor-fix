...
namespace ResEx
{
    ...
    {    
        ...
        private void UpdateResourceItemFromGridRow(DataGridViewRow row)
        {
            ...
            // Fix weird assembly inserted into xml when saving null values into neutral resx file.
            if (resourceSet.Culture == ResourceSet.NeutralCulture && localResourceItem.Value == null)
            {
                localResourceItem.Value = string.Empty;
            }
        ...
        private void ApplyCriteria()
        {
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in CustomDataGrid1.MainDataGridView.Rows)
                {
                    ...
                    if (key.StartsWith(treePath, StringComparison.OrdinalIgnoreCase))
                    {
